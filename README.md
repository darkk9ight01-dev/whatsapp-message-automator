...
Open terminal and run pip install groq
Add your Groq API key to the code
Run python filename.py
Enter student name, class and message type when prompted

### Built by: *Anmol Chourasia* — 15 year old developer from Amravati, Maharashtra
